...
use tendermint::node::info::{Info, TxIndexStatus};
...
use crate::{account::Balance, config::cosmos::ChainConfig as CosmosChainConfig};
...
impl ChainEndpoint for CosmosSdkChain {
    ...
    fn build_client_state(
        ...
        let settings = match settings {
            ...
            ClientSettings::Other => return Err(Error::build_client_state_failure()),
        };
        let unbonding_period = self.unbonding_period()?;
