...
//!
//! `Relayer` contains utilities for testing the `ibc` crate against the [Forcerelay IBC relayer][relayer-repo]. It acts
//! as scaffolding for gluing the `ibc` crate with Forcerelay for testing purposes.
//!
