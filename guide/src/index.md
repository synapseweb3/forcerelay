# Forcerelay Guide ({{#include templates/version.md}})

## Overview 

Forcerelay is an open-source Rust implementation of a relayer for the
...
This guide can help you set up, configure, operate and monitor Forcerelay to relay
...
We sometimes refer to Forcerelay as "IBC Relayer CLI", to make it clear that this is a relayer CLI (i.e., a binary) and distinguish it from the relayer core library (that is the crate called ibc-relayer).

Forcerelay is actively developed and maintained by [Informal Systems](https://informal.systems) in the [ibc-rs](https://github.com/informalsystems/hermes) repository.
...
* **[Quick start](./quick-start/index.md)**
  ...
  - This section can help you install Forcerelay.
...
* **[Advanced](./advanced/index.md)**
  - **[Features](./advanced/features.md)** 
      - This section summarizes Forcerelay' features and includes a comparison between the Cosmos Go relayer and Forcerelay.
...
* **[Documentation](./documentation/index.md)**
  ...
  - **[REST API](./documentation/rest-api.md)**
      - This section presents Forcerelay' REST API.
  - **[Commands Reference](./documentation/commands/index.md)**
      - This section describes the command line interface from which you can interact with Forcerelay.
...
* Educational resources
  ...
  - [Connect IBC enabled chains with Forcerelay](https://www.youtube.com/watch?v=_xQDTj1PcEw&t=4289s)
      - Video demonstration of Forcerelay at Hackatom 2021.

* Useful links
  - [Forcerelay FAQ Page](https://github.com/informalsystems/hermes/discussions/2472)
      - The official FAQ of Forcerelay.
  - [Forcerelay GitHub repository](https://github.com/informalsystems/hermes)
      - The official GitHub repository for Forcerelay.
...
- We would be grateful if you can submit a [bug report][bug-report]
  ...
  problem together;
- Reach Forcerelay developpers and other relayer operators on the [Cosmos Network Discord server](https://discord.com/invite/cosmosnetwork).

Lastly, for general questions, you can reach us at `hello@informal.systems`,
or on Twitter [@informalinc][twitter].

> Note that Forcerelay is packaged as part of the `ibc-relayer-cli` crate.
