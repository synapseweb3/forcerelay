...
```
{{#template ../../templates/commands/forcerelay/config/auto_1.md PATH=~/example_config.toml CHAIN_NAME:OPTIONAL_KEY_NAME=cosmoshub osmosis}}
...
```
{{#template ../../templates/commands/forcerelay/config/auto_1.md PATH=~/example_config.toml CHAIN_NAME:OPTIONAL_KEY_NAME=cosmoshub:random_key osmosis}}
...
```shell
{{#template ../../templates/commands/forcerelay/config/validate_1.md GLOBALOPTIONS=  --config $CONFIGPATH}}
```
