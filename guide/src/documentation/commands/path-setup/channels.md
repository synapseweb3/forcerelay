...
```shell
{{#template ../../../templates/commands/forcerelay/create/channel_1.md A_CHAIN_ID=ibc-0 A_CONNECTION_ID=connection-0 A_PORT_ID= transfer B_PORT_ID=transfer OPTIONS= --order unordered}}
```
...
```shell
{{#template ../../../templates/commands/forcerelay/create/channel_2.md A_CHAIN_ID=ibc-0 B_CHAIN_ID=ibc-1 A_PORT_ID= transfer B_PORT_ID=transfer OPTIONS= --order unordered}}
```
