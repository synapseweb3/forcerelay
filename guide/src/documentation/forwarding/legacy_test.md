...
[global]
  ...
  [global.forcerelay]
    binary = "$HOME/.forcerelay/bin/hermes"
    config = "$HOME/.forcerelay/config.toml"
    log_level = "trace"
...
* Run the commands: `{{#template ../../templates/commands/gm/forcerelay_config.md}}` and `{{#template ../../templates/commands/gm/hermes_keys.md}}`
